...
(function( $ ){
	...
	var methods = {
		...
		init : function( options )
		{
			...
			var notesnames = {  "Default":"Default" };
			...
			var menuItems = { 'screeneffects':true,
							  'fonteffects': true,
                              'insertoptions' : true,
							  'texteffects': true,
							  'aligneffects': true,
                              ...
                              'save'    : { "text": "Save",
                                            "icon":"fa fa-save",
                                            "tooltip": "Save note",
                                            "commandname":"save_notes",
                                            "custom":null },

                              'new'    : { "text": "New",
                                            "icon":"fa fa-file-text-o",
                                            "tooltip": "New note",
                                            "commandname":"new_note",
                                            "custom":null },

                              'share'    : { "text": "Share",
                                            "icon":"fa fa-share",
                                            "tooltip": "Share note",
                                            "commandname":"share_notes",
                                            "custom":null },
							  ...
							  'notesnames'	: { "select":true,
											"default": "Default",
											"tooltip": "Load notes",
											"commandname": "load_notes",
												"custom":null },
			...
			var menuGroups = {'texteffects' : ['bold', 'italics', 'underline', 'color'],
							  'textformats': ['indent', 'outdent', 'block_quote', 'ol', 'ul', 'insert_link', 'unlink', 'insert_img', 'hr_line', 'insert_table'],
							  'aligneffects': ['undo', 'redo', 'l_align','c_align', 'r_align', 'justify'],
							  'fonteffects' : ['fonts', 'styles', 'font_size'],
							  'actions' : ['print', 'togglescreen', 'share'],
							  'insertoptions' : ['new', 'save'],
							  'extraeffects' : ['strikeout', 'splchars'],
							  'advancedoptions' : ['rm_format', 'select_all', 'source'],
							  'screeneffects' : ['notesnames']
							};
			...
			var statusBar = $("<div/>", {	id : "statusbar_" + $(this).attr("id"),
	       	...
	       	if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").append('<div class="label" id="result"></div>');
            	});
	        }	        
